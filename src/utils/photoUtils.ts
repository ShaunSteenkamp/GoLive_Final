...
export const generatePhotoList = () => {
  ...
  const photos = mountainIndices.map(num => `/photos/027A0${String(num).padStart(3, '0')}.webp`);
  
  // Add DSC mountain shots
  photos.push(`/photos/DSC_8796.webp`);
  photos.push(`/photos/DSC_8772.webp`);
  photos.push(`/photos/DSC_8780.webp`);
